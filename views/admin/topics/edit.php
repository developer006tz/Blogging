  ...
  <main class="page-wrapper">
    ...
    <div class="page-content">
      <div class="admin-container">
        <form action="<?php url("/admin/topics/update/" . $this->id); ?>" method="post" class="admin-form sm-box">
          <h1 class="center form-title">Edit Topic</h1>
          ...
          <div class="input-group">
            ...
            <textarea
              ...
              id="description"
              cols="30"
              rows="4"><?php echo $this->description; ?></textarea>
          </div>
