...
<head>
  ...
  <title>Edit Permission - Admin</title>
</head>
  ...
  <main class="page-wrapper">
    ...
    <div class="page-content">
      <div class="admin-container">
        <form action="<?php url("/admin/permissions/update/" . $this->id); ?>" method="post" class="admin-form sm-box">
          <h1 class="center form-title">Edit Permission</h1>
