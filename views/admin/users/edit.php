  ...
  <main class="page-wrapper">
    ...
    <div class="page-content">
      <div class="admin-container">
        <form action="<?php url("/admin/users/update/" . $this->id); ?>" method="post" enctype="multipart/form-data" class="admin-form sm-box">
            ...
            <div class="input-group">
              ...
              <input type="password" name="oldPassword" value="<?php echo $this->oldPassword; ?>" id="oldPassword" class="input-control">
            </div>
            <div class="input-group">
