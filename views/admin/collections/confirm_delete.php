      ...
      <div class="admin-container">
        <div class="table-container lg-box">
          ...
          <div class="responsive-table" style="font-size: 18px;">
            <p>
              Are you sure you want to delete the collection titled <strong><i><?php echo $this->title; ?></i></strong> Permanently?
            </p>
            <p style="color: red">This action cannot be undone.</p>
            <a href="<?php url("/admin/delete-collection/" . $this->id); ?>" class="btn danger-btn small-btn">
                <ion-icon name="trash-outline" class="icon"></ion-icon> Permanently Delete
            </a>
            <a href="<?php url("/admin/collections"); ?>" class="btn">
              Do nothing
            </a>
          </div>
        </div>
